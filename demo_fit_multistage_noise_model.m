...
% improves estimation of neural responses across stimulus conditions")
...
runParallel = 0;                        % 0 will run without opening up a parallel pool of workers; 1 runs in parallel
maxIter = 1000;                         % maximum number of iterations to run optimization
