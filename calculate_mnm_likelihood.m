function [loglike,loglikes] = calculate_mnm_likelihood(prs,gSub,rSub,fname)
% [loglike,loglikes] = calculate_mnm_likelihood(prs,gSub,rSub,fname)
% 
% Calculates log-likelihood of data given model parameters (without
% parallel computing)
%
% Inputs: 
%   prs: parameters
